...
display.setDefault("background", 80/255, 131/255, 109/255)
...
local randomNumerSq
local userAnswer 
local correctAnswer local questionObject 
local correctObject 
...
numberCorrectText:setTextColor(24/255, 255/255, 223/255)
...
coin1 = display.newImageRect("Images/coin.vnd", 50, 50)
coin1.x = 980 
coin1.y = 70

coin2 = display.newImageRect("Images/coin.vnd", 50, 50)
coin2.x = 880 
coin2.y = 70

coin3 = display.newImageRect("Images/coin.vnd", 50, 50)
coin3.x = 780 
coin3.y = 70
...
youLose = display.newImageRect("Images/youLose.png", 824, 568)
youLose.x = -1000
youLose.y = 384
